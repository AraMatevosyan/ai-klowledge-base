...
describe('SearchService', () => {
    ...
    const detectQueryIntentMock =
        jest.mocked(detectQueryIntent);
    ...
    beforeEach(async () => {
        ...
        service =
            module.get(SearchService);

        detectQueryIntentMock.mockReturnValue(
            'FACTUAL' as QueryIntent,
        );

        embeddingsService.createOne
            .mockResolvedValue(
                QUERY_EMBEDDING,
            );
    });
